<template>
  ...
  <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center"><i class="far fa-8x fa-user-circle text-center" style="color: #127834 "></i></div>
      </div>
    </div>
  </div>
  <h4 class="pt-4" style=""><b>Nome do Utilizador</b></h4> <!--Maybe cor verde também? -->
      <hr>
      </div>
    </div>
    </div>
